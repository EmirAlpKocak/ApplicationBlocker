...
extern "C" __declspec(dllexport) void CriticalMonitorError(HWND window, const wchar_t* msg)
{
	TaskDialog(window, nullptr, L"Application Blocker", L"A critical error has been occured.", msg, TDCBF_OK_BUTTON, TD_ERROR_ICON, nullptr);
}